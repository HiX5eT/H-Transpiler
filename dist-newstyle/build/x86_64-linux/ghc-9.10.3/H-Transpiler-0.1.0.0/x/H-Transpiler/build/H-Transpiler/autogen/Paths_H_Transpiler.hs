...
-- at runtime using the environment variable H_Transpiler_bindir.
...
-- environment variable H_Transpiler_libdir.
...
-- using the environment variable H_Transpiler_dynlibdir.
...
-- runtime using the environment variable H_Transpiler_datadir.
...
-- variable H_Transpiler_libexedir.
...
-- using the environment variable H_Transpiler_sysconfdir.
...
libdir     = "/home/codespace/.cabal/lib/x86_64-linux-ghc-9.10.3-b4c3/H-Transpiler-0.1.0.0-inplace-H-Transpiler"
dynlibdir  = "/home/codespace/.cabal/lib/x86_64-linux-ghc-9.10.3-b4c3"
datadir    = "/home/codespace/.cabal/share/x86_64-linux-ghc-9.10.3-b4c3/H-Transpiler-0.1.0.0"
libexecdir = "/home/codespace/.cabal/libexec/x86_64-linux-ghc-9.10.3-b4c3/H-Transpiler-0.1.0.0"
sysconfdir = "/home/codespace/.cabal/etc"

getBinDir     = catchIO (getEnv "H_Transpiler_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "H_Transpiler_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "H_Transpiler_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "H_Transpiler_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "H_Transpiler_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "H_Transpiler_sysconfdir") (\_ -> return sysconfdir)
