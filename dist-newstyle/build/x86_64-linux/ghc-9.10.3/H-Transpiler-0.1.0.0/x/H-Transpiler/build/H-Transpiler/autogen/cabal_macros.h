...
/* package H-Transpiler-0.1.0.0 */
#ifndef VERSION_H_Transpiler
#define VERSION_H_Transpiler "0.1.0.0"
#endif /* VERSION_H_Transpiler */
#ifndef MIN_VERSION_H_Transpiler
#define MIN_VERSION_H_Transpiler(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_H_Transpiler */
...
/* package http-client-tls-0.4.0 */
#ifndef VERSION_http_client_tls
#define VERSION_http_client_tls "0.4.0"
...
#define CURRENT_COMPONENT_ID "H-Transpiler-0.1.0.0-inplace-H-Transpiler"
